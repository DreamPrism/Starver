...
namespace Starvers.Forms
{
	public partial class StarverManagerForm : Form
	{
		...
		private static int SLTX;
		private static int SLTY;
		private static Graphics Painter;
		private static int LastSelected = 0;
		private static SolidBrush Brush_Font;
		private static SolidBrush Brush_Selected;
		private static Rectangle Rec_Border;
